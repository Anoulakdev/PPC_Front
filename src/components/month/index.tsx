...
export default function MonthTable() {
  ...
  const fetchData = async () => {
    try {
      ...
      url = selectedPowerId
        ? `/monthpowers?powerId=${selectedPowerId}&sYear=${selectedYear}&sMonth=${selectedMonth}`
        : `/monthpowers?sYear=${selectedYear}&sMonth=${selectedMonth}`;
  ...
  const CreatePage = () => {
    router.push("/declaration/month/create");
  };
