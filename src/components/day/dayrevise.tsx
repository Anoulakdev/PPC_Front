...
export default function DayRevise() {
  ...
  const handleDailyRemarkChange = (value: string) => {
    setData({
      ...data,
      powerCurrent: {
        ...data.powerCurrent,
  ...
  const handleRevise = async () => {
    try {
      ...
      await axiosInstance.put(`/daypowers/revise/${data?.id}`, payload);
  ...
  return (
    <div className="rounded-xl bg-white p-6 shadow-lg dark:bg-gray-900 dark:text-gray-100">
      <h1 className="mb-5 text-center text-xl font-bold">
        Daily Availability Declaration (Revise)
      </h1>
        ...
        <>
          <div className="overflow-x-auto">
            <table className="table-auto border text-left">
              ...
              <tbody>
                ...
                {/* Footer Total Per Unit + Grand Total */}
          ...
          <div className="mt-4">
            <textarea
              ...
              onChange={(e) => handleDailyRemarkChange(e.target.value)}
