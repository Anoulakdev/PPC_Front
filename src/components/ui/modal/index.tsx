...
export const Modal: React.FC<ModalProps> = ({
  ...
  const finalIsFullscreen = isFullscreen || isMobile;
  const contentClasses = finalIsFullscreen
    ? "w-full h-full"
    : "relative w-full sm:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-2 rounded-3xl bg-white dark:bg-gray-900";
