...
export default function AddEvent({ isOpen, onClose, onAdd }: AddEventProps) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      data.append("preventive", formData.preventive);
      data.append("remark", formData.remark);

      if (uploadedFile) data.append("eventFile", uploadedFile);
            ...
            <div className="mt-2 grid grid-cols-1 gap-x-3 gap-y-5 lg:grid-cols-2">
              ...
              <div>
                ...
                <TextArea
                  ...
                  onChange={(value) =>
                    setFormData((prev) => ({ ...prev, rootCause: value }))
                  }
                />
              </div>
            </div>
            ...
            <div className="mt-2 grid grid-cols-1 gap-x-3 gap-y-5 lg:grid-cols-2">
              <div>
                ...
                <TextArea
                  ...
                  onChange={(value) =>
                    setFormData((prev) => ({ ...prev, preventive: value }))
                  }
                />
              </div>
