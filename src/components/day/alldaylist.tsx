...
import DatePickerAll from "../form/date-pickerall";
...
export default function DayTable() {
  ...
  const fetchData = async () => {
    try {
      ...
      url = selectedPowerId
        ? `/daypowers/alldocument?powerId=${selectedPowerId}&startDate=${start}&endDate=${end}`
        : `/daypowers/alldocument?startDate=${start}&endDate=${end}`;
