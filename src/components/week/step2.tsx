...
export const Step2 = () => {
  const { formData, updateFormData, prevStep, resetForm } = useWeekPowerStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosInstance.post("/weekpowers", payload);
      resetForm();
      toast.success("Added successfully!");
      router.push("/declaration/week");
    } catch (err) {
