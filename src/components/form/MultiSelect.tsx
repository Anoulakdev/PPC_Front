      ...
      <div className="relative z-20 inline-block w-full">
        <div className="relative flex flex-col items-center">
          <div onClick={toggleDropdown} className="w-full">
            <div className="shadow-theme-xs focus:border-brand-300 focus:shadow-focus-ring dark:focus:border-brand-300 mb-2 flex min-h-11 rounded-lg border border-gray-300 py-1.5 pr-3 pl-3 outline-hidden transition dark:border-gray-700 dark:bg-gray-900">
              ...
              <div className="flex w-7 items-center py-1 pr-1 pl-1">
                <button
                  ...
                  className="pointer-events-none absolute top-1/2 right-3 pb-2 -translate-y-1/2 text-gray-500 dark:text-gray-400"
                >
                  <svg
          ...
          {isOpen && (
            <div
              className="absolute top-full left-0 z-40 max-h-60 w-full overflow-y-auto rounded-lg bg-white shadow-sm dark:bg-gray-900"
