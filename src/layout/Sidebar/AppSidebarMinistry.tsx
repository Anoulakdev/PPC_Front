...
const navItems: NavItem[] = [
  ...
  //   name: "Dashboard",
  //   subItems: [
  //     { name: "Daily", path: "/dashboard/day", pro: false },
  //     { name: "Weekly", path: "/dashboard/week", pro: false },
  //     { name: "Monthly", path: "/dashboard/month", pro: false },
  //   ],
  // },
  // {
  //   name: "All Document",
  ...
  // },
  {
    ...
    icon: <PaperPlaneIcon />,
    subItems: [
      { name: "Daily Report", path: "/dispatch/createreport", pro: false },
      // {
      //   name: "Net Energy Output Report",
      //   path: "/dispatch/netenergyoutput",
      //   pro: false,
      // },
    ],
  },
              ...
              <ul className="mt-2 ml-9 space-y-1">
                {nav.subItems.map((subItem) => (
                  <li key={subItem.name}>
                    ...
                    >
                      {subItem.icon && (
                        <span className="text-gray-500">{subItem.icon}</span> // ✅ เพิ่มแสดง icon
                      )}
                      {subItem.name}
